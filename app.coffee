...
introMessage = "Welcome, if you haven't already, please introduce yourself here. 
You're welcome to unsubscribe from the channel afterward if you'd rather not see group requests."
