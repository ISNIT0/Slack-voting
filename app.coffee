...
request 'https://slack.com/api/rtm.start?token='+keys.slack, (e,res,body)->
...
app.post '/region', (req, res)->
  if req.body.text.length<=1 then res.send 'Please use `/region list` to view a list of all regions.'
    ...
    request 'https://slack.com/api/groups.list?token='+keys.slack+'&exclude_archived=1', (e,response,body)->
    ...
    request 'https://slack.com/api/groups.create?token='+keys.slack+'&name=reg_'+req.body.text.split(' ')[1], (e, response, body)->
     ...
     request 'https://slack.com/api/groups.list?token='+keys.slack+'&exclude_archived=1', (e,response,body)->
       request 'https://slack.com/api/groups.invite?token='+keys.slack+'&user='+
